...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card" style="z-index:3;width:320px;" id="mySidebar">
  <a href="javascript:void(0)" class="w3-bar-item w3-button w3-border-bottom w3-large"><img src="https://github.com/JINHEEWON/metanet_java_study/assets/35156107/f6f14967-3b25-4a49-8230-74e6fbb835b2" style="width:80%"></a>
...
<div class="container">
  <h2 style="padding-top:30px">사원목록</h2>
...
<p>
<input class="w3-input" type="text" name="searchename" style="width:90%; margin-left:80px" required>
</p>
<button class="w3-button w3-section w3-teal w3-ripple" style="margin-left:80px"> 검색 </button>
</form>
</div>
