...
public class Ex13_abstract_class {
	...
	public static void main(String[] args) {
		...
		if(tank instanceof Unit) {	//tank 객체는 Unit타입입니까 - true
			System.out.println("true");
		} else {
			System.out.println("false");
		}
		
		if(tank instanceof Tank) {	//tank 객체는 Unit타입입니까 - true
			System.out.println("true");
		} else {
			System.out.println("false");
		}
		...
		//2. 여러개의 (Tank 1대, Marine 1사람, DropShip 1대 )만들고 같은 좌표(666,888)으로 이동 시키세요
		//다형성
