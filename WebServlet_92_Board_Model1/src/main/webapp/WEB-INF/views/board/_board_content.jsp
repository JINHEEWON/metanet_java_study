	...
	<div id="pageContainer">
		<div style="padding-top: 30px; text-align: center">
			<center>
				...
				<table width="80%" border="1">
					...
					<tr height="100">
						...
						<c:if test="${not empty requestScope.board.content}">
    						<c:set var="formattedContent" value="${fn:replace(requestScope.board.content, '\\\\n', '<br>')}" />
				...
				<br>
				<!-- 꼬리글 목록 테이블 -->
					<c:if test="${not empty requestScope.replylist and fn:length(requestScope.replylist) > 0}">
    <table width="80%" border="1">
        <tr>
        ...
        <c:forEach var="reply" items="${requestScope.replylist}">
            <tr align="left">
                <td width="80%">
                    ...
                    <br> 작성일:${reply.writedate.toString()}
                </td>
                <td width="20%">
